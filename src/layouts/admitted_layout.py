...
admitted_layout = dmc.MantineProvider(
    ...
    children=[
                            ...
                            dbc.Col(
                                dmc.Stack(
                                    ...
                                    children=[
                                        ...
                                        dmc.Text(
                                            "Admitted pathways show completed treatments where patients were admitted to hospital for care.",  # optional subtitle
        ...
        dbc.Container(
            [         
                html.Div(id="dummy-trigger-admitted", children=1, style={"display": "none"}),
                dcc.Store(id="admitted-selected-icb", storage_type="memory"),
                dbc.Row(
                    [
                        dbc.Col(
                            [
                                ...
                                html.Span(id="metric-help-icon-admitted", style={"marginLeft": "6px"}),
                                    ],
                ...
                dbc.Row([dbc.Col([dcc.Graph(id="admitted-line-chart")])]),
                html.Hr(),
                dbc.Row(
                    [
                        dbc.Col(
                            [
                                ...
                                dcc.Graph(id="admitted-bar-chart", style={"height": "450px"}),
                            ],
                            md=8,
                        ),
                        dbc.Col(
                            [
                                ...
                                html.Div(
                                    id="admitted-manual-selection-section",
                                    children=[
                                        html.Label("Select up to 5 Treatment Functions"),
                                        dmc.MultiSelect(
                                            id="admitted-treatment-function-checklist",
                                            data=[],
                ...
                html.Hr(),
                html.Div(
                    id="admitted-imd-block",
                    children=[
                dbc.Row(
                    [
                        # LEFT: Dash Leaflet map
                        dbc.Col(
                            [
                                html.H5("Deprivation and Waiting Times across ICBs",
                                        className="mb-3"),
                                html.H6(id="admitted-imd-regional-subtitle", className="mb-2"),  
                                html.Div(
                                    id="admitted-imd-map",
                                    style={
                                        "height": "520px",
                                        "width": "100%",
                                        "background": "#f2f4f7",  # placeholder bg so you can see it rendered
                        ...
                        dbc.Col(
                            [
                                dcc.Graph(id="admitted-icb-rtt-bars", style={"height": "460px"}),

                                dbc.Button(
                                    "Clear selection",
                                    id="admitted-clear-icb-selection",
                                    color="secondary",
                                    outline=True,
                                    size="sm",
                                    className="mt-2",
                ...
                html.Div(
                    id="admitted-national-imd-block",
                    children=[
                        dbc.Row([
                            dbc.Col(
                                [
                                    html.H5("Compare ICBs by Deprivation and Population", className="mb-3"),
                                    html.H6(id = "admitted-imd-national-subtitle", className="mb-2"),
                                    dcc.Graph(id="admitted-national-imd-scatter", style={"height": "520px"}),
                                ],
                                md=12,
                            ),
                        ])
                ...
                dmc.Drawer(
                    ...
                    padding="md",
                    children=html.Div(id="help-body-admitted"),
                ),   
            ],
            fluid=True,
        )
